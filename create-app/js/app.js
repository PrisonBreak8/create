(() => {
  ...
  const F = {
    ...
    updateSlides: function () {
      ...
      if (
        ...
        D(e.wrapperEl, "--swiper-centered-offset-before", -u[0] + "px"),
          D(
            e.wrapperEl,
  ...
  function ve(e) {
    ...
    function d() {
      ...
      if (
        ("fraction" === s.type &&
          (a.find(ge(s.currentClass)).text(s.formatFractionCurrent(d + 1)),
          a.find(ge(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
  ...
  window.addEventListener("load", function (e) {
    be(),
      document.querySelector(".tutors__slider") &&
        new he(".tutors__slider", {
          modules: [fe],
          observer: !0,
          observeParents: !0,
          slidesPerView: 4,
          ...
          breakpoints: {
            ...
            1230: { slidesPerView: 4, spaceBetween: 30 },
          },
          on: {},
        }),
      document.querySelector(".testimonials__slider ") &&
        new he(".testimonials__slider ", {
          modules: [fe, ve],
          observer: !0,
          observeParents: !0,
          slidesPerView: 1,
      ...
      we.addEventListener("click", (e) => {
        ...
        switch (
          (s.classList.contains("list__item") &&
            (Ee.forEach((e) => e.classList.remove("tab-active")),
  ...
  Te &&
    Te.addEventListener("click", () => {
      (Te.textContent = Le ? "Hidden" : "Load more"),
        (Le = !Le),
        xe.forEach((e) => e.classList.toggle("js-hidden"));
    });
  const Ae = document.querySelector(".search-text"),
    $e = document.querySelectorAll(".blocks__row .blocks__item");
  Ae &&
    Ae.addEventListener("keyup", function (e) {
      const t = e.target.value.toLowerCase();
      $e.forEach((e) => {
        e
          .querySelector(".cards__job-title")
  ...
  if (ke) {
    ...
    function De(e) {
      if (e.length > 9) {
        let t = [];
        Math.floor(e.length / 9);
        for (let s = 0; s < e.length; s += 9) t.push(e.slice(s, s + 9));
        return t;
      }
      return e;
    }
    ...
    function Be() {
      (Pe.innerHTML = ""),
        Ie.length > 1 &&
          (Ie.map((e, t) =>
            Pe.insertAdjacentHTML(
              "beforeend",
              `<li class="pagination-item${
                0 === t ? " active" : ""
              }" data-part="${t}"><a href="#">${t + 1}</a></li>`
            )
          ),
          Pe.insertAdjacentHTML(
            "afterbegin",
            '<li class="pagination-item item-prev disable"><a href="#"><i class="_icon-arrow-right" aria-hidden="true"></i></a></li>'
          ),
          Pe.insertAdjacentHTML(
            "beforeend",
    ...
    qe(0),
      ...
      Pe.addEventListener("click", (e) => {
        ...
        if (t) {
          let e,
            s = Pe.querySelector(".pagination-item.active");
          if (
            t.classList.contains("item-prev") ||
            t.classList.contains("item-next")
          ) {
          ...
          i.classList.contains("disable") && i.classList.remove("disable"),
            n.classList.contains("disable") && n.classList.remove("disable"),
            0 === e && i.classList.add("disable"),
            e === Ie.length - 1 && n.classList.add("disable");
        }
      });
  }

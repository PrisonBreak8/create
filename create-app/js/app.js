(() => {
  ...
  function pe(e) {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          (a.find(ce(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          a.find(ce(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
    ...
    function p() {
      ...
      if ("bullets" === e.type) {
        ...
        i.html(a), (t.pagination.bullets = i.find(ce(e.bulletClass)));
      }
      "fraction" === e.type &&
        ((a = e.renderFraction
  ...
  const fe = document.querySelectorAll(".menu__link");
  function me() {
    fe.forEach((e) => e.classList.remove("js-active-link")),
      this.classList.add("js-active-link");
  }
  console.log(fe),
    fe.forEach((e) => e.addEventListener("click", me)),
